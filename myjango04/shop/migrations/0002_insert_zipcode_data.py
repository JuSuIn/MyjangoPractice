# Generated by Django 5.1.1 on 2024-12-15 07:09
...
def get_chunks(iterable: Iterator, chunk_size: int = 100) -> Iterator:
    ...
    for first in iterator:
        ...
        yield itertools.chain([first], itertools.islice(iterator, chunk_size))
...
def add_zipcode_data(apps, schema_editor):
    ...
    for chunk in get_chunks(zipcode_list, chunk_size=1000):
        print("chunk size ::", len(list(chunk)))
        ZipCode.objects.bulk_create(chunk)
